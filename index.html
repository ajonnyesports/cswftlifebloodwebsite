...
<head>
    ...
    <title>LifeBlood - Blood Donation s</title>
...
<body class="bg-slate-100 h-[100dvh] overflow-hidden flex flex-col items-center">
    ...
    <!-- ========================================== -->
    <a href="https://www.mediafire.com/file/9emjltxpw6ymds6/CSWFTLIFEBLOOD.apk/file" target="_blank" class="w-full bg-slate-900 text-white py-3 px-4 flex justify-between items-center z-[100] shrink-0 shadow-md hover:bg-slate-800 transition-colors cursor-pointer border-b border-slate-700">
